          ...
          <div className="mt-4 pt-4 border-t border-slate-600/30">
            <div className="flex items-center space-x-4">
              <button
                onClick={async () => {
                  ...
                  const vaults = await VaultEventService.fetchVaultObjectsWithState(
                    filters.adminAddress || '0x9b15baa31a2d308bd09f9258f0a9db09da3d4e8e113cf1888efa919d9778fa7c'
                  )
              ...
              <button
                onClick={() => {
                  updateFilters({ 
                    adminAddress: '0x9b15baa31a2d308bd09f9258f0a9db09da3d4e8e113cf1888efa919d9778fa7c',
